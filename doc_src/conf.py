...
version = geocamMapMixer.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamMapMixer.get_version()
...
htmlhelp_basename = 'geocamMapMixerdoc'
...
latex_documents = [
  ('index', 'app.tex', u'geocamMapMixer Documentation',
   u'Trey Smith', 'manual'),
]
